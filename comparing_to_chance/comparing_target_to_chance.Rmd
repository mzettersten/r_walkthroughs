...
A quick simulation to demonstrate that comparing %target choices to chance is equivalent to comparing % target choices to %distractor choices (where %distractor = 1 - %target).
...
As we can see, the results of the t-test comparing proportion target choices to chance are the same as the paired t-test comparing target choices to distractor choices.